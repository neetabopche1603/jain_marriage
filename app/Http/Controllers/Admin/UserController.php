...
class UserController extends Controller
{
    ...
    public function userOtherDetails(Request $request)
    {
        return [
            ...
            'partner_country' => $request->partner_country ?? null,
            'partner_state' => $request->partner_state ?? null,
            'partner_city' => $request->partner_city ?? null,
            'partner_education' => $request->partner_education ?? null,
            'partner_education_desc' => $request->partner_education_desc ?? null,
            'partner_occupation' => $request->partner_occupation ?? null,
            'partner_profession' => $request->partner_profession ?? null,
            'partner_hobbies' => $request->partner_hobbies ?? null,
            'partner_manglik' => $request->partner_manglik ?? null,
            'partner_marital_status' => $request->partner_marital_status ?? null,
